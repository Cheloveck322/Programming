...
public:
    ...
    void setupUi(QMainWindow *Table)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images-20251001/new.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionNew->setIcon(icon1);
        actionOpen = new QAction(Table);
        actionOpen->setObjectName("actionOpen");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images-20251001/open.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionOpen->setIcon(icon2);
        actionSave = new QAction(Table);
        actionSave->setObjectName("actionSave");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images-20251001/save.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/images-20251001/cut.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCut->setIcon(icon4);
        actionCopy = new QAction(Table);
        actionCopy->setObjectName("actionCopy");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/images-20251001/copy.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCopy->setIcon(icon5);
        actionCopy->setVisible(true);
        actionPaste = new QAction(Table);
        actionPaste->setObjectName("actionPaste");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images-20251001/paste.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images-20251001/find.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionFind->setIcon(icon7);
        actionGo_to_Cell = new QAction(Table);
        actionGo_to_Cell->setObjectName("actionGo_to_Cell");
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images-20251001/gotocell.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/images-20251001/icon.png"), QSize(), QIcon::Normal, QIcon::Off);
