...
{
    bool ok = false;
    QString addr = QInputDialog::getText(this, tr("Go to cell"), tr("Cell (e.g., A1):"), QLineEdit::Normal, QString(), &ok);
    ...
    QString colStr = rx.cap(1).toUpper();
    int row = rx.cap(2).toInt() - 1;
    int col = 0;
